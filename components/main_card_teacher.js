                ...
                <div className="flex flex-col mt-4">
                    ...
                    <div className="font-normal mt-1 flex flex-col p-2">
                        <div className="mt-2 flex flex-col justify-center items-center">
                            ...
                            <label className="text-md">Month:&nbsp; <span>XXXXX</span></label>
                            <label className="text-md">Percentage:&nbsp; <span>XXXXX</span></label>
                        </div>
                    </div>
                </div>
            </div>
            <div className="w-80 p-4 h-max shadow-md m-10 rounded-sm hover:shadow-xl ease-out-in">
                <div className="flex flex-col mt-4">
                    ...
                    <div className="font-normal mt-1 flex flex-col p-2">
                        ...
                        <label className="text-md mt-2">Contact: &nbsp; <span>XXXXX</span></label>
                        <label className="text-md mt-2">About: &nbsp; <span>XXXXX</span></label>
                    </div>
                </div>
            </div>
            <div className="w-80 p-4 h-max shadow-md m-10 rounded-sm hover:shadow-xl ease-out-in">
